...
export const Navbar = () => {
  ...
  return (
    <nav
      id="header"
      className="w-full fixed top-0 left-0 z-30 py-4 bg-gray-900"
    >
      <div className="w-full flex items-center justify-between px-6">
        ...
        <div className="flex items-center">
          <button
            className="bg-gray-700 text-white p-3 rounded md:hidden"
            onClick={toggleMenu}
          >
            Menu
          </button>
          ...
          <div className="hidden md:flex items-center">
            ...
            <button
              className="bg-white text-black p-3 rounded mr-2"
              onClick={handleNavigateToSettingsPage}
            >
              Transferir
            </button>
            <button
              className="bg-black text-white p-3 rounded mr-2"
      ...
      {isOpen && (
        <div className="md:hidden w-full flex flex-col items-start bg-gray-900 p-4">
          <button
            className="bg-gray-700 text-white p-3 rounded my-1 w-full text-left"
            onClick={handleNavigateToChannelsPage}
          >
            Browse
          </button>
          <button
            className="bg-white text-black p-3 rounded my-1 w-full text-left"
            onClick={handleNavigateToSettingsPage}
          >
            Transferir
          </button>
          <button
            className="bg-black text-white p-3 rounded my-1 w-full text-left"
            onClick={handleLoginLogout}
          >
            {isLoggedIn ? "Log out" : "Login"}
          </button>
